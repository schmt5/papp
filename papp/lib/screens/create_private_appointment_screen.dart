...
class CreatePrivateAppointmentScreen extends StatefulWidget {
  static const routeName = '/create-private-appointment';
  @override
  _CreatePrivateAppointmentScreenState createState() =>
      _CreatePrivateAppointmentScreenState();
}

class _CreatePrivateAppointmentScreenState
    extends State<CreatePrivateAppointmentScreen> {
  final _form = GlobalKey<FormState>();
  DateTime _selectedDate;
  TimeOfDay _selectedTime;
  PrivateAppointmentModel _createdItem;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Privater Termin Erstellen'),
      ),
      body: Form(
        key: _form,
        child: ListView(
